...
public partial class GetUMPStx : Parser {
	...
	public partial class SimpleEqContext : KvEqContext {
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode NL() { return GetToken(GetUMPStx.NL, 0); }
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode FLOAT() { return GetToken(GetUMPStx.FLOAT, 0); }
		...
		try {
			...
			case 5:
				...
				if (_la==FLOAT || _la==V) {
					{
					State = 99;
					((SimpleEqContext)_localctx).val = TokenStream.LT(1);
					_la = TokenStream.LA(1);
					if ( !(_la==FLOAT || _la==V) ) {
						((SimpleEqContext)_localctx).val = ErrorHandler.RecoverInline(this);
					}
					else {
						ErrorHandler.ReportMatch(this);
					    Consume();
			...
			case 6:
				...
				if (_la==FLOAT || _la==V) {
					{
					State = 108;
					((IdxEqContext)_localctx).val = TokenStream.LT(1);
					_la = TokenStream.LA(1);
					if ( !(_la==FLOAT || _la==V) ) {
						((IdxEqContext)_localctx).val = ErrorHandler.RecoverInline(this);
					}
					else {
						ErrorHandler.ReportMatch(this);
					    Consume();
	...
	private static int[] _serializedATN = {
		...
		2,4,6,8,10,12,14,0,2,1,0,11,12,2,0,14,14,18,18,130,0,19,1,0,0,0,2,28,1,
		0,0,0,4,30,1,0,0,0,6,39,1,0,0,0,8,48,1,0,0,0,10,57,1,0,0,0,12,66,1,0,0,
		0,14,115,1,0,0,0,16,18,3,2,1,0,17,16,1,0,0,0,18,21,1,0,0,0,19,17,1,0,0,
		0,19,20,1,0,0,0,20,22,1,0,0,0,21,19,1,0,0,0,22,23,5,0,0,1,23,1,1,0,0,0,
		24,29,3,4,2,0,25,29,3,6,3,0,26,29,3,8,4,0,27,29,3,10,5,0,28,24,1,0,0,0,
		28,25,1,0,0,0,28,26,1,0,0,0,28,27,1,0,0,0,29,3,1,0,0,0,30,34,5,1,0,0,31,
		33,3,14,7,0,32,31,1,0,0,0,33,36,1,0,0,0,34,32,1,0,0,0,34,35,1,0,0,0,35,
		37,1,0,0,0,36,34,1,0,0,0,37,38,5,10,0,0,38,5,1,0,0,0,39,43,5,2,0,0,40,
		42,3,14,7,0,41,40,1,0,0,0,42,45,1,0,0,0,43,41,1,0,0,0,43,44,1,0,0,0,44,
		46,1,0,0,0,45,43,1,0,0,0,46,47,5,10,0,0,47,7,1,0,0,0,48,52,5,3,0,0,49,
		51,3,14,7,0,50,49,1,0,0,0,51,54,1,0,0,0,52,50,1,0,0,0,52,53,1,0,0,0,53,
		55,1,0,0,0,54,52,1,0,0,0,55,56,5,10,0,0,56,9,1,0,0,0,57,61,5,4,0,0,58,
		60,3,14,7,0,59,58,1,0,0,0,60,63,1,0,0,0,61,59,1,0,0,0,61,62,1,0,0,0,62,
		64,1,0,0,0,63,61,1,0,0,0,64,65,5,10,0,0,65,11,1,0,0,0,66,67,5,12,0,0,67,
		68,5,13,0,0,68,13,1,0,0,0,69,70,7,0,0,0,70,71,5,7,0,0,71,72,5,15,0,0,72,
		74,5,19,0,0,73,75,5,8,0,0,74,73,1,0,0,0,74,75,1,0,0,0,75,116,1,0,0,0,76,
		77,3,12,6,0,77,78,5,7,0,0,78,79,5,15,0,0,79,81,5,19,0,0,80,82,5,8,0,0,
		81,80,1,0,0,0,81,82,1,0,0,0,82,116,1,0,0,0,83,84,7,0,0,0,84,85,5,7,0,0,
		85,86,5,16,0,0,86,88,5,19,0,0,87,89,5,8,0,0,88,87,1,0,0,0,88,89,1,0,0,
		0,89,116,1,0,0,0,90,91,3,12,6,0,91,92,5,7,0,0,92,93,5,16,0,0,93,95,5,19,
		0,0,94,96,5,8,0,0,95,94,1,0,0,0,95,96,1,0,0,0,96,116,1,0,0,0,97,98,7,0,
		0,0,98,100,5,7,0,0,99,101,7,1,0,0,100,99,1,0,0,0,100,101,1,0,0,0,101,102,
		1,0,0,0,102,104,5,19,0,0,103,105,5,8,0,0,104,103,1,0,0,0,104,105,1,0,0,
		0,105,116,1,0,0,0,106,107,3,12,6,0,107,109,5,7,0,0,108,110,7,1,0,0,109,
		108,1,0,0,0,109,110,1,0,0,0,110,111,1,0,0,0,111,113,5,19,0,0,112,114,5,
		8,0,0,113,112,1,0,0,0,113,114,1,0,0,0,114,116,1,0,0,0,115,69,1,0,0,0,115,
		76,1,0,0,0,115,83,1,0,0,0,115,90,1,0,0,0,115,97,1,0,0,0,115,106,1,0,0,
		0,116,15,1,0,0,0,15,19,28,34,43,52,61,74,81,88,95,100,104,109,113,115
	};
